...
//   //SET PINMODE DONE IN MAIN // pinMode(CAN0_INT, INPUT); // Configuring pin
//   for /INT input
// }
...
//   len); Serial.print(msgString); for (byte i = 0; i < len; i++) {
...
// float CAN::process_data_frame_vesc(char datatype, unsigned char byte1,
//                                    unsigned char byte2) {
//   char receivedByte[4], *p;
...
// int CAN::hex2int(char buf[]) { return (short)strtol(buf, NULL, 16); }
